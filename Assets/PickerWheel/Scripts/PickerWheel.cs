...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      public SO_LuckyDraw SO_LuckyDraw;
      ...
      private void Awake () {
        ...
        public void OpenPickerWheel()
        {
            gameObject.SetActive(true);
            //animator.Play("Open");
        }

        public void ClosePickerWheel()
        {
...
/*         RectTransform rt = wheelPiecePrefab.transform.GetChild (0).GetComponent <RectTransform> () ;
      ...
      private void DrawPiece (int index) {
         ...
         Transform pieceTrns = InstantiatePiece ().transform.GetChild (0) ;
            ...
            wheelPieces[index].Currency = SO_LuckyDraw.luckyDraws[index].currencyType;
            wheelPieces[index].Chance = SO_LuckyDraw.luckyDraws[index].rate;
            switch (SO_LuckyDraw.luckyDraws[index].currencyType)
            {
                case CurrencyType.GOLD:
                    pieceTrns.GetChild(0).GetComponent<RewardSpinElement>().SetData(SO_LuckyDraw.luckyDraws[index].currencyType,
                        SO_LuckyDraw.luckyDraws[index].gold);
                    wheelPieces[index].Amount = SO_LuckyDraw.luckyDraws[index].gold;
                    break;
                case CurrencyType.GEM:
                    pieceTrns.GetChild(0).GetComponent<RewardSpinElement>().SetData(SO_LuckyDraw.luckyDraws[index].currencyType,
                        SO_LuckyDraw.luckyDraws[index].gem);
                    wheelPieces[index].Amount = SO_LuckyDraw.luckyDraws[index].gem;
                    break;
                case CurrencyType.POWER_STONE:
                    pieceTrns.GetChild(0).GetComponent<RewardSpinElement>().SetData(SO_LuckyDraw.luckyDraws[index].currencyType,
                        SO_LuckyDraw.luckyDraws[index].powerStone);
                    wheelPieces[index].Amount = SO_LuckyDraw.luckyDraws[index].powerStone;
                    break;
                default:
                    break;
            }
