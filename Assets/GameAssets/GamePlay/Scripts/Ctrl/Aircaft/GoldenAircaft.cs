...
public class GoldenAircaft : BaseAircaft
{
    [SerializeField]
    ...
    public float coolDownLab => Cfg.labCtrl.LapManager.GetSingleSubjectById(IdSubjectType.GOLDEN_AIRCRAFT_COOLDOWN).GetCurrentProperty();
    public float durationLab => Cfg.labCtrl.LapManager.GetSingleSubjectById(IdSubjectType.GOLDEN_AIRCRAFT_DURATION).GetCurrentProperty();
