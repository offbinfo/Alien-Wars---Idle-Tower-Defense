...
public class PopupCardInfoRoll : UIPanel, IBoard
{
    ...
    public static PopupCardInfoRoll Instance { get; private set; }
    private void Awake()
    {
        Instance = this;
    }
    ...
    {
        return UiPanelType.PopupCardInfoRoll;
    }
